...
link_doc = picked_object.GetLinkDocument()

print(link_doc)

print('\n ***')

link_elem = FilteredElementCollector(link_doc).OfCategory(BuiltInCategory.OST_Doors).WhereElementIsNotElementType().ToElements()

for i in link_elem:
	print('door: {}'.format(i.Name))
