...
outlets = [i.LookupParameter("f8647c6f-38c5-4fbb-9aaf-382cd04e78c5").AsString() for i in all_rooms]

check = [i for i in outlets if (len(i)) >= 0]

for i in check:
    print(i)

print("Rooms: {}".format(len(all_rooms)))
print("Steckdosen: {}".format(len(outlets)))
